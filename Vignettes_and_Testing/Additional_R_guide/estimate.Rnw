...
%% The following code was taken from Ross Ihaka's guide:
...
This file includes some small modifications to Sweave, following the
guidelines in \url{http://www.stat.auckland.ac.nz/~stat782/downloads/Sweave-customisation.pdf}.
